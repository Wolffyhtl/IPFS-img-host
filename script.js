document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleUpload(file) {
                ...
                if (xhr.status === 200) {
                    ...
                    if (data.status === 'ok') {
                        ...
                        gsap.to(fakeProgress, {
                            ...
                            onUpdate: () => updateProgress(fakeProgress.val),
                            onComplete: () => {
                                const displayUrl = data.web2url.replace('ipfs.crossbell.io', 'ipfs.tianhw.top');
        ...
        xhr.open('POST', 'https://ipfs-relay.crossbell.io/upload', true);
        xhr.send(formData);
    }
            ...
            tl.to(progressContainer, {
                ...
                onComplete: () => {
                    ...
                    previewImage.onload = () => {
                        ...
                        gsap.to(previewImage, { autoAlpha: 1, duration: 0.8, ease: 'power2.out' });
                    };
                }
            })
